...
const stats = {
  createView(request, response) {
    ...
    let maxSongsPlaylists = playlists.filter(playlist => playlist.songs.length === maxSongs);
    let songsTitles = maxSongsPlaylists.map(playlist => playlist.title);
    ...
    const statistics = {
        ...
        Largest: maxSongs,
        displayLargestPlaylistTitles: songsTitles,
    };
